...
import { patients, inPatients, outPatients, nextOfKin, appointments, staff, wards, localDoctors, patientReferrals } from "../data/mockData"
...
function Patients() {
  ...
  const referal = patientReferrals.find(r => r.patient_no === selected)
        ...
        <div className="card">
          ...
          <div className="card__body" style={{ paddingBottom: 0 }}>
            <div className="toolbar mb-16">
              <input
                ...
                placeholder="Search name or patient no…"
                value={search}
          ...
          <div className="table-wrap">
            <table className="table">
              <thead>
                <tr><th>No.</th><th>Name</th><th>Sex</th><th>DOB</th><th>Status</th></tr>
              </thead>
              <tbody>
                {filtered.map(pt => {
                  ...
                  return (
                    <tr
                      key={pt.patient_no}
                      className={selected === pt.patient_no ? "selected" : ""}
                      style={{ cursor: "pointer" }}
                      onClick={() => { setSelect(pt.patient_no); setTab("details") }}
                    >
